"""
Django settings for MasomoBora project.
...
SECRET_KEY = 'django-insecure-74lymx+7q54enn&**43nsk#(uha!bxe44^x5@*__b_n3(^v@yd'
...
WSGI_APPLICATION = 'MasomoBora.wsgi.application'
